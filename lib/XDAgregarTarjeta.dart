...
class XDAgregarTarjeta extends StatelessWidget {
  XDAgregarTarjeta({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(23.0, 136.0, 368.0, 432.0),
            size: Size(414.0, 736.0),
            child:
                // Adobe XD layer: 'Formulario' (group)
                Stack(
              children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(192.0, 128.0, 24.0, 24.0),
            size: Size(414.0, 736.0),
            fixedWidth: true,
            fixedHeight: true,
            child:
...
const String _svg_38a1ey =
    '<svg viewBox="68.0 168.0 280.0 164.0" ><path transform="translate(68.0, 168.0)" d="M 0 0 L 280 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(68.0, 247.0)" d="M 0 0 L 280 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(273.0, 328.0)" d="M 0 0 L 56 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(83.0, 331.0)" d="M 0 0 L 81 1" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
